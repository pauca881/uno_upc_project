...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-item" href="{{ route('torneos') }}" data-bs-toggle="dropdown">Torneos</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="addtorneo">Añadir torneo</li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <footer class="bd-footer py-4 py-md-5 mt-5 bg-body-tertiary fixed-bottom">
