...
class Datos extends \Faker\Datos {

    public static function firstNameESP() {
        $firstName = array(
        ...
        return array_rand($firstName, 1);
    }


    public static function lastNameESP() {
        $lastName = array(
        ...
        return array_rand($lastName, 1);
    }

    
    public static function torneosName() {
        $torneos = array(
