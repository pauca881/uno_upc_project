...
/**
 * @{{--  --}}--}} \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\tplayer>
 */
class tplayerFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        // $firstNameESP = $firstName[array_rand($firstName, 1)];
        // $lastNameESP = $lastName[array_rand($lastName, 1)];

        return [
            'name' => fake()->randomElement($firstName),
            'surname' => fake()->randomElement($lastName),
